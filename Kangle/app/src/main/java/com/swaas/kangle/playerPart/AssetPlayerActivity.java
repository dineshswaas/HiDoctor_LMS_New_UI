...
//    }
    ...
    private void getDigitalAssetList() {
       ...
       /* digitalAssetsList = new ArrayList<>();
        DigitalAssets digitalAssets = new DigitalAssets();
        digitalAssets.setDA_Code(1);
        digitalAssets.setDA_Type(Constants.VIDEOASSET);
        digitalAssets.setDA_Online_URL("https://media011.blob.core.windows.net/000/VID-20170526-WA0011_740abc6c-1825-4711-9afb-37ab3ffd5efe.mp4");

        DigitalAssets digitalAssetsone = new DigitalAssets();
        digitalAssetsone.setDA_Code(2);
        digitalAssetsone.setDA_Type(Constants.PDFASSET);
        digitalAssetsone.setDA_Online_URL("https://media011.blob.core.windows.net/000/PRD_-_Field_DCR_OTC_Entry_Screen_cc976aaf-1778-4764-9fae-19451c65034b.pdf");


        DigitalAssets digitalAssetstwo = new DigitalAssets();
        digitalAssetstwo.setDA_Code(3);
        digitalAssetstwo.setDA_Type(Constants.IMAGEASSET);
        digitalAssetstwo.setDA_Online_URL("https://media011.blob.core.windows.net/000/001_Accompanied_Call_Entry_c9a22bcf-0a55-483c-bfee-931486112fab.png");


        DigitalAssets digitalAssetsthree = new DigitalAssets();
        digitalAssetsthree.setDA_Code(4);
        digitalAssetsthree.setDA_Type(Constants.AUDIOASSET);
        digitalAssetsthree.setDA_Online_URL("https://media011.blob.core.windows.net/000/The_Sword_Of_Destiny-StarMusiQ.Com_07696077-a1fe-4de7-8fc4-9701c169da83.mp3");


        DigitalAssets digitalAssetsfour = new DigitalAssets();
        digitalAssetsfour.setDA_Code(5);
        digitalAssetsfour.setDA_Type(Constants.HTMLASSET);
        digitalAssetsfour.setDA_Online_URL("https://media011.blob.core.windows.net/000/6._TB_-_GGR_-_Analizando_las_finanzas_-_LA&C_1f4bd89a-660e-4b20-9408-3d81b7ff60a3/story_html5.html");

        digitalAssetsList.add(digitalAssets);
        digitalAssetsList.add(digitalAssetsone);
        digitalAssetsList.add(digitalAssetstwo);
        digitalAssetsList.add(digitalAssetsthree);
        digitalAssetsList.add(digitalAssetsfour);
       */
