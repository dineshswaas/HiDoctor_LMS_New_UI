...
public class DigitalAssetPlayerActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, OnAssetChangeListener, MyAssetPlayerViewPager.OnSwipeOutListener, PopupMenu.OnMenuItemClickListener {
    ...
    public DigitalAssetTransactionRepository mDigitalAssetRepository;
    public DigitalAssetTransactionChildRepository mDigitalAssetchildRepository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digital_asset_player);
        ...
        detector = new GestureDetector(this, new DigitalAssetPlayerActivity.GestureTap());
    }
            ...
            if (predictions.size() > 0) {
                ...
                if (prediction.score > 1.0) {
                    ...
                    if (prediction.name.equals("lineupdown")){
                        ...
                        viewAnimator = com.github.florent37.viewanimator.ViewAnimator
                                ...
                                .onStop(new AnimationListener.Stop() {
                                    ...
                                    public void onStop() {
                                        ...
                                        Log.d("=>test",""+digitalAssetsList.get(CurrentGesturePosition).getDA_Name());
                                        digitalAssetsList.get(CurrentGesturePosition).setUser_Like(1);
                                        mGestureImage.setVisibility(View.GONE);
                        ...
                        Toast.makeText(DigitalAssetPlayerActivity.this, prediction.name, Toast.LENGTH_SHORT).show();
                    }
...
//    }
    ...
    private void ViewInialization() {
        ...
        mDigitalAssetRepository = new DigitalAssetTransactionRepository(this);
        mDigitalAssetchildRepository = new DigitalAssetTransactionChildRepository(this);
        mToast =  new Toast(this);
        gpsTracker = new GPSTracker(DigitalAssetPlayerActivity.this);
    ...
    private void getDigitalAssetList() {
        ...
        mBtn_GestureOverlay_Closeview.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void SetPdfAction(int itemId) {
        ...
        try {
            PdfViewFragment pdfViewFragment = (com.swaas.kangle.DigitalAssetPlayer.fragments.PdfViewFragment) pageSlideAdapter.getFragment(AssetPlayerPager.getCurrentItem());
    ...
    public boolean InsertPlayerStartTime(int playerstarttime, int currentAssetPosition,int playmode) {
        ...
        mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentAssetPosition), false);
        return true;
    ...
    public void InsertImageDetailStartTime(int currentassetposition, Date starttime, int sessionId) {
        ...
        if (sessionId!= 0 ){
            ...
            digitalAssetsList.get(currentassetposition).setSessionId(mDigitalAssetRepository.getAssetSessionId(digitalAssetsList.get(currentassetposition).getDA_Code())+1);
        }
        digitalAssetsList.get(currentassetposition).setPart_Id(1);
        if (starttime != null){
    ...
    private void setCustomerDetail(int currentassetposition) {
        ...
        DigitalAssets dig = digitalAssetsList.get(currentassetposition);

        digitalAssetsList.get(currentassetposition).setLattitude(gpsTracker.getLatitude());
        digitalAssetsList.get(currentassetposition).setLongitude(gpsTracker.getLongitude());
        digitalAssetsList.get(currentassetposition).setTotal_Views(dig.getTotal_Views()+1);
    ...
    public void InsertPartUrlStartTimeEvent(int currentassetpsition,Date parturlstarttime,String parturl){
        ...
        mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentassetpsition), false);
    ...
    public void InsertHtmlDetailStarttime(int currentassetposition,Date starttime){
        ...
        if (starttime != null){
            ...
            digitalAssetsList.get(currentassetposition).setDetailed_StartTime(df.format(starttime));
            digitalAssetsList.get(currentassetposition).setSessionId(getCurrentSessionId(currentassetposition)+1);
            digitalAssetsList.get(currentassetposition).setPlayMode(1);
            mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentassetposition), false);
    ...
    public void InsertPartUrlStartTime(int currentassetpsition,Date parturlstarttime,String parturl){
        ...
        digitalAssetsList.get(currentassetpsition).setPlayer_Start_Time("0");
        digitalAssetsList.get(currentassetpsition).setPart_URL(parturl);
        digitalAssetsList.get(currentassetpsition).setPlayMode(1);
        //mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentassetpsition), false);
    ...
    public void InsertFinalParturlEndTime(int currentposition,Date parturlendtime){
        ...
        if (digitalAssetsList.get(currentposition).getPlayer_Start_Time()!=null){
            ...
            mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentposition), false);
    ...
    public void UpdatePageStartTime(int currentassetposition,Date pagestarttime,int page,int playmode){
        ...
        digitalAssetsList.get(currentassetposition).setPlayMode(playmode);
        digitalAssetsList.get(currentassetposition).setPlayer_Start_Time("0");
        mDigitalAssetchildRepository.insertRecord(digitalAssetsList.get(currentassetposition));
        //mDigitalAssetRepository.insertOrUpdateDAAnalytics(digitalAssetsList.get(currentassetposition),false);
