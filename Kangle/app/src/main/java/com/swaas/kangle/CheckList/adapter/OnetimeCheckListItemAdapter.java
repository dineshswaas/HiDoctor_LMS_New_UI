...
public class OnetimeCheckListItemAdapter extends RecyclerView.Adapter<OnetimeCheckListItemAdapter.CheckListRecyclerHolder>{
    ...
    public OnetimeCheckListItemAdapter(Context context, List<CheckListModel> courseModels) {
